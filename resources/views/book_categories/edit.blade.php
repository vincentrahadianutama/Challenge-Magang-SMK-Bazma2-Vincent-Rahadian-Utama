<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto px-6 py-8">
        <h1 class="text-2xl font-semibold text-gray-900 mb-6">Edit Book Category</h1>
        ...
        @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="{{ $category->name }}" required class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
            </div>
